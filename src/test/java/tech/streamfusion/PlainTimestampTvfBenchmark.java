...
class PlainTimestampTvfBenchmark {
  ...
  void compareAssignment() throws Exception {
    for (String shape : new String[] {"TUMBLE", "HOP", "CUMULATE"}) {
      ...
      System.out.printf(
          Locale.ROOT,
          "[plain-tvf] %s rows=%d Flink=%.6fs Native=%.6fs flink_trials=%s native_trials=%s%n",
          shape,
          ROWS,
          median(seconds[0]),
          median(seconds[1]),
  ...
  private static TableEnvironment environment() {
    ...
    // The blackhole sink observes values, so neither of the two rowtime columns is a sink timestamp.
                    ...
                    Row.of(
                        ...
                        i % 8 == 0
                            ...
                            : LocalDateTime.ofEpochSecond(
                                i % 4096 - 2048, 999_999_999, ZoneOffset.UTC)))
            .returns(Types.ROW_NAMED(new String[] {"id", "ts"}, Types.INT, Types.LOCAL_DATE_TIME))
