...
class FlinkIntervalExprSqlHarnessTest {
  ...
  @Test
  void intervalComparisonAfterTopNMatchesHost() throws Exception {
    NativeParity.assertChangelogParity(
        () -> {
          StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
          env.setParallelism(1);
  ...
  @Test
  void intervalOuterJoinResidualMatchesHost() throws Exception {
    NativeParity.assertChangelogParity(
        () -> {
          StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
          env.setParallelism(1);
  ...
  @Test
  void nanosecondTimestampDifferenceMatchesHost() throws Exception {
  ...
  @Test
  void yearMonthIntervalChosenPerRowMatchesHost() throws Exception {
    NativeParity.assertParity(
        () -> {
          StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
          env.setParallelism(1);
