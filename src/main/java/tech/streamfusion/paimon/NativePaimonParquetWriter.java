 ...
 * passes the bundle through takes the direct path. The footer stays a standard parquet-rs footer, so
 * Paimon extracts statistics from it exactly as from its own files.
 */
